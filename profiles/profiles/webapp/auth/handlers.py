...
from profiles.model import message, session, user
from profiles.model.user import PasswordHistory as password_history

from profiles.model import numberoffailedloginattemps as loginattempt
from profiles.webapp.auth import scrubbers


log = logging.getLogger(__name__)

module_template_prefix = 'auth'
module_template_package = 'profiles.webapp.auth.authtemplates'
